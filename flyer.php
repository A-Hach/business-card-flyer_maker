        ...
        <div class="container text-center">
            ...
            <?php
                 ...
                 $r = @mysqli_query($dbc, $query);
                    ...
                    $prix=$row['0'];
            echo '<h1 class="heading-1">FLYERS > '.$nom.'</h1>';
        ...
        <div class="card border-4 mb-4" id="price_calculator">
            ...
            <div class="card-body p-0">
                <div class="price_calculator">
                    <input type="hidden" name="prod_baseprice" id="prod_baseprice" value="220">
                    ...
                    <form name="pricecalulate" id="pricecalulate" method="POST" action="/ajaxfunctions.php" onsubmit="return false;" autocomplete="off" novalidate="novalidate">
                        ...
                        <input type="hidden" name="prdid" id="prdid" value="90">
                            ...
                            <div id="prductqty" class="form-group calcrow align-items-center  kit_prductqty ">
                                ...
                                <div id="div_prductqty" class="">
                                    <div class="dropdown bootstrap-select kit_prdqty show-tick rightalign" style="width: 100%;">
                                        <select id="prdqty" name="quantite" onchange="Prix()" class="selectpicker kit_prdqty show-tick rightalign" data-width="100%" data-show-subtext="true" data-style="btn-dropdown" tabindex="-98">
                            ...
                            <div id="additionaloptionid" class="kit_additionaloptionid ">
                                <div class="option-group">
                                    <div class="page-section-header border-bottom mb-3 pb-2">
                                        <h4 class="card-title m-0"><a id="button9028" href="#collapse9028" class="group-collapse-button accordion-toggle " data-toggle="collapse" aria-expanded="true">Personnalisez Vos Options Flyer <i class="fal fa-caret-square-down float-right"></i></a></h4></div>
                                    <div id="collapse9028" class="collapse show ">
                                        <div class="row mb-3 narrow-gutter align-items-start">
                                            <div class="form-group calcrow align-items-center  mb-2  col-4 ">
                                                <div class="col-12 px-0">
                                                    <label class="">Papier</label>
                                                </div>
                                                <div class="col-12 px-0">
                                                    <div class="dropdown bootstrap-select rightalign show-tick" style="width: 100%;">
                                                        <select name="papier" id="aoptions[31]" onchange="Prix()" class="selectpicker rightalign show-tick" data-width="100%" data-show-subtext="true" data-style="btn-dropdown " tabindex="-98">
                                                            <option selected="selected" data-content="" value="115g">115 g</option>
                                                            <option data-content="" value="135g">135 g</option>
                                                            <option data-content="" value="170g">170 g</option>
                                                            <option data-content="" value="250g">250 g</option>
                                                            <option data-content="" value="300g">300 g</option>
                                                        </select>
                                            ...
                                            <div class="form-group calcrow  mb-2  col-4 ">
                                                <div class="col-12 px-0">
                                                    <label class="">Type</label>
                                                </div>
                                                <div class="col-12 px-0">
                                                    <div class="custom-control custom-radio ">
                                                        <input type="radio" data-color="blue" onchange="Prix()" class="custom-control-input " data-default="1" data-id="1" id="730" name="pelliculage"  value="Brillant" data-customclass="   ">
                                                        <label class="custom-control-label" for="730" data-original-title="Brillant " data-toggle="tooltip">Brillant </label>
                                                    </div>
                                                    <div class="custom-control custom-radio ">
                                                        <input type="radio" data-color="blue"  onchange="Prix()" class="custom-control-input " data-default="0" data-id="2" id="729" name="pelliculage" checked="checked" value="Mat" data-customclass="   ">
                                                        <label class="custom-control-label" for="729" data-original-title="Mat " data-toggle="tooltip">Mat </label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group calcrow  mb-2  col-4 ">
                                                <div class="col-12 px-0">
                                                    <label class="">Impression</label><a href="javascript:void(0);" data-easein="fadeInDown" data-placement="bottom" data-toggle="popover" data-container="body" data-trigger="click" title="" id="opt32" data-original-title="Aide"><i class="fa fa-question-circle ml-2"></i></a>
                                                    <div class="d-none" id="opt32_content">
                                                        <div class="help_popup">
                                                            <p>Recto ou Recto Verso</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-12 px-0">
                                                    <div class="custom-control custom-radio ">
                                                        <input type="radio" data-color="blue" onchange="Prix()" class="custom-control-input " data-default="0" data-id="1" id="68" name="impression" checked="checked" value="recto" data-customclass="   ">
                                                        <label class="custom-control-label" for="68" data-original-title="Recto" data-toggle="tooltip">Recto</label>
                                                    </div>
                                                    <div class="custom-control custom-radio ">
                                                        <input type="radio" data-color="blue" onchange="Prix()" class="custom-control-input " data-default="1" data-id="2" id="69" name="impression"  value="verso" data-customclass="   ">
                                                        <label class="custom-control-label" for="69" data-original-title="Recto/Verso" data-toggle="tooltip">Recto/Verso</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
            ...
            mysqli_connect_error());
                    $sql = "INSERT INTO clienttemplate VALUES (".$id.",".$_SESSION['compte'].",'null','null','null')";
                                   ...
                                   mysqli_query($dbc, $sql);
                                    $sql1 = "INSERT INTO PanierDetailes VALUES (".$_SESSION['compte'].",'".$_GET['name']."','".$_GET['type']."' , ".$_POST['quantite'].",'".$_GET['name']."','".$_POST['papier']."','".$_POST['impression']."','null','".$_POST['pelliculage']."',".$_COOKIE['prix'].",".$id.")";
                                    mysqli_query($dbc, $sql1);
                                    $_SESSION['template']=$id;
                                    header('Location: design(complex).php?h=520&w=360&a=4&b=2');
                                    ob_end_flush();
                }
            }
            else{
            ...
            mysqli_connect_error());
                    $sql = "INSERT INTO clienttemplate VALUES (".$id.",".$_SESSION['compte'].",'null','null','null')";
                                   ...
                                   mysqli_query($dbc, $sql);
                                    ...
                                    mysqli_query($dbc, $sql1);
                                    $_SESSION['template']=$id;
                                    header('Location: template.php?type=F');
                                    ob_end_flush();
                }
            }
            else{
...
function Prix(){
    ...
    papier=document.getElementById("aoptions[31]").selectedIndex+1;
    if(document.getElementById("68").checked){
        impression=0;
        document.cookie = "side=1";
    }
    else if(document.getElementById("69").checked){
        impression=1;
    ...
    else if(document.getElementById("729").checked){
        pelliculage=1;
    }
