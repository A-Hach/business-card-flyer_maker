...
<div id="canvas2" style="display: none" ></div>
        ...
        <!-- OUTPUT SECTION-->
          ...
          <div class="col-sm-12 col-md-6" >
             ...
             <div id="card1">
              <h3 id="outputCompany1">Company Name</h3>



              <p id="outputMessage1" class="small">Company Message</p><hr>
              <p id="outputName1" class="small">Your Name</p>
              <p id="outputJob1" class="small">Job Title</p>
              <p id="outputEmail1" class="small">Email:</p>
              <p id="outputPhone1" class="small">Tel:</p>
          ...
          <br>
             <div id="card2" style="visibility: hidden">
              <h3 id="outputCompany2">Company Name</h3>



              <p id="outputMessage2" class="small">Company Message</p><hr>
              <p id="outputName2" class="small">Your Name</p>
              <p id="outputJob2" class="small">Job Title</p>
              <p id="outputEmail2" class="small">Email:</p>
              <p id="outputPhone2" class="small">Tel:</p>
