          ...
          <div class="col-md-9">
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <br>
                <table class="table table-striped table-hover" id="cmd">
                      <tr>
                        <th>Id Commande</th>
                        <th>Id Client</th>
                        <th>Date</th>
                  ...
                  while($row=mysqli_fetch_array($r)){
                     ...
                     echo'    
                     <td>'.$row1['0'].' DHs</td>
                     <td><button type="submit" name="Details" class="btn btn-primary">Details</button></td>
                     </form>
                   </tr>';}
                      ?>
                      <?php 
                      ...
                      function Details(){
                        ...
                        header('Location:details.php?cmd='.$_COOKIE['cmd'].'');
                        ob_end_flush();
       }?>
                    </table>
              </div>
