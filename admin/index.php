          ...
          <div class="col-md-9">
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                <div class="col-md-3">
                  <div class="well dash-box"><?php
                  
                    echo'<h2><span class="glyphicon glyphicon-user" aria-hidden="true"></span> '.$users.'</h2>';?>
                    <h4>Users</h4>
                  </div>
                </div>
                ...
                <div class="col-md-3">
                  ...
                  <?php
                    ...
                    echo'<h2><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span>'.$cmd.'</h2>';?>
